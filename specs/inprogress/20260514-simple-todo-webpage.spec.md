...
- [x] Whether a later task should split CSS/JS into separate assets or introduce a bundler (**Resolution:** deferred to a follow-up spec; explicitly out of scope here).
